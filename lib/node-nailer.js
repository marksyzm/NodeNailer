...
var downloadSource = exports.downloadSource = function(source, saveTo, callback) {
  ...
  request({
    ...
    if (res.statusCode != 200)
      return callback(new Error("The source returns a non-200 status code: " + res.statusCode));
      
    if (!res.headers['content-type'].test('image'))
      return callback(new Error("The source does not appear to be a valid image"), source, saveTo);
